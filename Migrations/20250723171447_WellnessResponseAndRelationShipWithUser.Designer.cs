...
namespace play_360.Migrations
{
    ...
    [Migration("20250723171447_WellnessResponseAndRelationShipWithUser")]
    partial class WellnessResponseAndRelationShipWithUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("play_360.EF.Models.WellnessResponse", b =>
                {
                    ...
                    b.Property<int>("WellnessQuestionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("play_360.EF.Models.WellnessResponse", b =>
                {
                    ...
                    b.HasOne("play_360.EF.Models.WellnessQuestion", "WellnessQuestion")
                        .WithMany("WellnessResponses")
                        .HasForeignKey("WellnessQuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
